...
# 多次 runs 输出平均值
# res = {x: {y: 0 for y in ['precision', 'recall', 'f1-score']} for x in ['核心', '系统', '应用', '其它']}
# res['accuracy'] = 0
# for layer in ['核心', '系统', '应用', '其它']:
#     for report in report_list:
#         res[layer]['precision'] += report[layer]['precision']
#         res[layer]['recall'] += report[layer]['recall']
#         res[layer]['f1-score'] += report[layer]['f1-score']
#     res[layer]['precision'] /= len(report_list)
#     res[layer]['recall'] /= len(report_list)
#     res[layer]['f1-score'] /= len(report_list)
#     res[layer]['support'] = report_list[0][layer]['support']
# for report in report_list:
#     res['accuracy'] += report['accuracy']
# res['accuracy'] /= len(report_list)
# print(res)
