...
from util import sparse_mx_to_torch_sparse_tensor
...
class Sampler_FastGCN(Sampler):
    ...
    def sampling(self, v):
        ...
        return sampled_X0, all_support, cur_sampled, 0
    ...
    def _one_layer_sampling(self, v_indices, output_size):
        ...
        # print("sage---")
        # print("v_indices", type(v_indices), v_indices.shape)
        # print("support", type(support), support.shape)
        # print("neis", type(neis), neis.shape)
        # print("sampled", type(sampled), sampled.shape)
        # print("u_sampled", type(u_sampled), u_sampled.shape)
        # print('---')
